...
mongoose.connect('mongodb://localhost:27017/challenge-confere-transaction-test', {
...
describe('Transaction', () => {
  ...
  it('allows you to create a credit type transaction', async () => {
    ...
    const transaction = await createTransactionService.execute(mockCredit)
  ...
  it('allows you to create a debit type transaction', async () => {
    ...
    const transaction = await createTransactionService.execute(mockDebit)
  ...
  it('allows you to create a installment credit type transaction', async () => {
    ...
    const transaction = await createTransactionService.execute(mockInstalmentsCredit)
  ...
  it('allows you to return all transactions', async () => {
    ...
    await userService.execute({name: "Ítalo", email: "italo@email.com", password: "123456"})
    const {token} = await createSessionService.excute({email: "italo@email.com", password: "123456"})
    await createTransactionService.execute(mockCredit);
